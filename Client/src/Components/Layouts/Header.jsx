    ...
    <div className='max-w-screen border-zinc-200 shadow sahd'>
      ...
      {!open && (
        <div className='flex max-w-screen font-bold h-16 justify-between items-center px-5 sm:px-0'>
          <div className='flex w-[15%] sm:pl-20'>
          ...
          <h4 className=' sm:flex gap- hidden sm:pr-20 justify-center items-center'>
            <Link className='flex w-26 ' to='/das'>Home</Link>
            <Link className='flex w-26 ' to='/my'>my order</Link>
      ...
      {open && (
        <div className='bg-black flex flex-col text-amber-50 h-screen w-screen'>
          ...
          <h3 className='w-screen flex flex-col gap-8 items-center text-3xl justify-center mt-15'>
          <Link onClick={() => setOpen(false)} to='/das'>Home</Link>

            <Link onClick={() => setOpen(false)} to='/my'>My Order</Link>
            <Link onClick={() => setOpen(false)} to='/p'>My Profile</Link>
